...
**Local**: Godot editor → GdUnit panel → Run All
**CI**: Push to `main` or open PR → GitHub Actions runs automatically
...
## Required Test Coverage (per coding standards)

- Minimum: 80% code coverage
- Required systems: Balance formulas, card resolution engine, shop system, special hand detection
